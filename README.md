...
- كتالوج من 52 مصدرًا رسميًا وقانونيًا وأكاديميًا وإحصائيًا وإخباريًا وحقوقيًا.
- 29 مصدرًا بقنوات جمع مباشرة: 22 RSS و3 Sitemaps و13 موصل HTML و6 واجهات API رسمية؛ منها 9 مصادر متعددة القنوات، دون الاعتماد على Google News.
- تدقيق حي للمصادر الـ52 يختبر XML وروابط المقالات وسجلات JSON، ويميز الحجب و429 والتحويلات غير المتوافقة.
