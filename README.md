...
- 29 مصدرًا بقنوات جمع مباشرة: 18 RSS وSitemap واحدة و13 موصل HTML و3 واجهات API رسمية؛ منها 6 مصادر متعددة القنوات، دون الاعتماد على Google News.
- تدقيق حي للمصادر الـ33 يختبر XML وروابط المقالات وسجلات JSON، ويميز الحجب و429 والتحويلات غير المتوافقة.
