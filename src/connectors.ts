...
export const SOURCE_CONNECTORS: Readonly<Record<string, SourceConnector>> = {
  ...
  "egyptian-bar-association": { kind: "api", endpointUrl: "https://egyls.com/wp-json/wp/v2/posts?per_page=20&_fields=id,link,date_gmt,modified_gmt,title,excerpt,content", adapter: "wordpress_posts", canonicalUrlBase: "https://egyls.com" },
